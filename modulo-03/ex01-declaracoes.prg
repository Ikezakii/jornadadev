FUNCTION Main()
    ...
    LOCAL aLista := {cNome_funcionario, nSalario, lAtivo, dAdmissao, nCod_departamento}

    FOR EACH elemento in alISTA

        QOut("Tipo de dado: " + Valtype(elemento))
...
//Fazer com uma lista e fazer um loop printando?